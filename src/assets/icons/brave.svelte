...
<svg
	...
	{...restProps}
	><defs
		><linearGradient id="logosBrave0" x1="0%" x2="100.097%" y1="50.018%" y2="50.018%"
			><stop offset="0%" stop-color="#FFF" /><stop
				offset="14.13%"
				stop-color="#FFF"
				stop-opacity=".958"
			/><stop offset="100%" stop-color="#FFF" stop-opacity=".7" /></linearGradient
		><linearGradient id="logosBrave1" x1="-.039%" x2="100%" y1="49.982%" y2="49.982%"
			><stop offset="0%" stop-color="#F1F1F2" /><stop offset="9.191%" stop-color="#E4E5E6" /><stop
				offset="23.57%"
				stop-color="#D9DADB"
			/><stop offset="43.8%" stop-color="#D2D4D5" /><stop
				offset="100%"
				stop-color="#D0D2D3"
			/></linearGradient
		></defs
	...
	/><path
		fill="url(#logosBrave0)"
		d="M34.5 227.7L0 99.5l10.1-25.1l-7-18.6l16.7-17c5.5-4.9 16.3-6.6 21.3-3.7l26.1 15l34 7.9l26.5-11l2.2 227.7c-.4 32.8 1.7 29.3-22.4 13.8L48 248.6c-6.4-6.1-11.3-13-13.5-20.9"
		opacity=".15"
	/><path
		fill="url(#logosBrave1)"
		d="m202.2 252.246l-50.6 34.6c-14.1 7.7-20.9 15.3-22 11.6c-.9-2.9-.2-11.4-.5-24.6l-.6-222.7c.1-2.2 1.6-5.9 4.2-5.5l25.8 7.8l37.2-5.8l24.6-18.1c2.6-2 6.4-1.8 8.8.5l22 21c2 2.1 2.1 6.2.9 8.8l-6.1 11.3l10.1 26.1l-34.8 129.4c-5.4 16.1-13 20.3-19 25.6"
		opacity=".4"
	/><path
		fill="#FFF"
